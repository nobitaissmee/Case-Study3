                    ...
                    <div class="row">
                        ...
                        <div class="table-data__tool">
                            <div class="table-data__tool-left">
                                <a href="admin-post?action=add"
                                   class="au-btn au-btn-icon au-btn--green au-btn--small"> <i
                                        class="fa fas-plus"></i>add post
                                </a>
                            </div>
                    ...
                    <div class="row">
                        <div class="table-responsive table-responsive-data2">
                            <table class="table table-data2">
                                ...
                                <tr class="tr-shadow">
                                    <td class="shorten">${post.title}</td>
                                    <td class="shorten">${post.shortContent}</td>
                                    <td>${post.pulishDate}</td>
                                    <td><img src="${pageContext.servletContext.contextPath}/${post.image}" alt="image" style="height: 100px;width: 10000px"></td>
                                    <td>${post.category.name}</td>
                                    <td>${post.views}</td>
                                    <td>
                                        <div class="table-data-feature">
                                            <a href="admin-post?action=edit&id=${post.id}"
                                               class="item" data-toggle="tooltip" data-placement="top"
                                               title="Edit"> <i class="fas fa-edit"></i>
                                            </a> <a href="admin-post?action=delete&id=${post.id}"
                                                    class="item" data-toggle="tooltip" data-placement="top"
